<?php
	...
	Plugin URI: http://socratesplugins.com
	...
	Version: 1.1
	Author URI: http://socratesplugins.com
	*/
	...
	if(!class_exists("RandomLinks")) {
		class RandomLinks {
			...
			function getAdminPageHeader() { 
				...
				$rss_url = "http://www.socratestheme.com/demo/feed/rss/";
			...
			<div id="socrates_plugin_header">
				<div id="socrates_plugin_header_title">
					<div id="socrates_plugin_header_title_title">
						Random Links
					</div>
					
					<div id="socrates_plugin_header_title_links">
						<ul>
							<li><a href="http://www.socratestheme.com/?ref=randomlinks">Socrates Theme</a></li>
							<li>&#124;</li>
							<li><a href="http://www.socratestheme.com/forum/">Socrates Forums</a></li>
							<li>&#124;</li>
							<li><a href="http://www.socratesplugins.com">Socrates Plugins</a></li>				
						</ul>
					</div>
				</div>
				
				<div id="socrates_plugin_header_subtitle">
					<a href="http://www.socratestheme.com/demo/"><img id="rss" src="<?php bloginfo('wpurl') ?>/wp-content/plugins/random-links/images/rss.png" width="12" height="12"></a>&nbsp;&nbsp;Socrates Feed
				</div>
				...
				<div id="socrates_plugin_header_content">
					...
					<div id="socrates_plugin_header_content_right">
						<div id="socrates_plugin_header_content_right_title">
							S<span id="socrates_plugin_header_logo_omega">&#937;</span>crates Plugins<br/>
						</div>
				...
				<div id="socrates_plugin_header_bottom">
				</div>
			</div>
